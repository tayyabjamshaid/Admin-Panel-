...
import {
  fetchReportedUsers,
  blockFromAllUserPage,
} from "Reducers/fetchReportedUsers";
...
function Tables() {
  ...
  }, [userArray, currentPage, search, reportedUsers, ITEMS_PER_PAGE]);
                              ...
                              "APPROVED" ? (
                                <Button
                                  ...
                                  onClick={() => {
                                    dispatch(
                                      blockFromAllUserPage({
                                        user_id: userAllData?.reported?.user_id,
                                        status: "BLOCKED",
                                        blocked_for: "FOR_REPORT",
                                        page: "REPORT_PAGE",
                                      })
                                    );
                                  }}
